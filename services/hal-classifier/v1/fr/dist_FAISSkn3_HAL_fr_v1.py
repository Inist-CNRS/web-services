...
model=fasttext.load_model("./v1/fr/Model_Class0HalFr_FT_d60_w5_e10_b40m.bin")
D=np.load("./v1/fr/HALfr_matrixKDT_Model_Class0HalFr_FT_d60_w5_e10_b40m.npy")

dico_nd_pkl=open("./v1/fr/dicoFR_nd.pkl","rb")    
...
verb_class={"chim":{"code":"chim","labelFr":"Chimie","labelEn":"Chemical Sciences"},
            ...
            "nlin":{"code":"nlin","labelFr":"Science non linéaire [physics]","labelEn":"Nonlinear Sciences [physics]"},
            "phys":{"code":"phys","labelFr":"Physique [physics]","labelEn":"Physics [physics]"},
            "qfin":{"code":"qfin","labelFr":"Économie et finance quantitative [q-fin]","labelEn":"Quantitative Finance [q-fin]"},
            ...
            "sdu":{"code":"sdu","labelFr":"Planète et Univers [physics]","labelEn":"Sciences of the Universe [physics]"},
            "sdv":{"code":"sdv","labelFr":"Sciences du Vivant [q-bio]","labelEn":"Life Sciences [q-bio]"},
            "shs":{"code":"shs","labelFr":"Sciences de l'Homme et Société","labelEn":"Humanities and Social Sciences"},
            "spi":{"code":"spi","labelFr":"Sciences de l'ingénieur [physics]","labelEn":"Engineering Sciences [physics]"},
