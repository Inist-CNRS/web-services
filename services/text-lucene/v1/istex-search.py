...
def construct_llm_prompt(user_prompt):
    ...
    **Liste des champs disponibles** : {fields_doc}
    ...
    ```
    (title:("réchauffement climatique" "réchauffement planétaire" "réchauffement global" "changement climatique" "dérèglement climatique") OR abstract:("réchauffement climatique" "réchauffement planétaire" "réchauffement global" "changement climatique" "dérèglement climatique")) AND language.raw:("fre")
    ```
    ...
    ```
    (title:("biodiversity" "marine biodiversity" "ocean biodiversity" "oceanic biodiversity") OR abstract:("biodiversity" "marine biodiversity" "ocean biodiversity" "oceanic biodiversity")) AND (title:("north mediterranean" "north mediterranean sea") OR abstract:("north mediterranean" "north mediterranean sea")) AND language.raw:("eng") AND genre.raw:"research-article" AND publicationDate:[2020 TO *]
    ```
