...
# "citing_doi": [{"doi": "DOI1", "title": "Titre1"},{"doi": "DOI2", "title": "Titre2"}]}}
    ...
    for entry in info["doi"]:
        clean_citing_doi.append({"doi": entry["doi"],"title": normalize_title(entry["title"])})
    sys.stdout.write(json.dumps({"id": citation_info["doi"],"value": {"title": clean_title,"count": info["count"],"citing_doi": clean_citing_doi}}))
    sys.stdout.write("\n")
