...
- [data-corpussummarize](./services/data-corpussummarize) [![Docker Pulls](https://img.shields.io/docker/pulls/cnrsinist/ws-data-corpussummarize.svg)](https://hub.docker.com/r/cnrsinist/ws-data-corpussummarize/)
- [data-geonames](./services/data-geonames) [![Docker Pulls](https://img.shields.io/docker/pulls/cnrsinist/ws-data-geonames.svg)](https://hub.docker.com/r/cnrsinist/ws-data-geonames/)
...
- [data-kwsimilarity](./services/data-kwsimilarity) [![Docker Pulls](https://img.shields.io/docker/pulls/cnrsinist/ws-data-kwsimilarity.svg)](https://hub.docker.com/r/cnrsinist/ws-data-kwsimilarity/)
...
- [loterre-annotate](./services/loterre-annotate) [![Docker Pulls](https://img.shields.io/docker/pulls/cnrsinist/ws-loterre-annotate.svg)](https://hub.docker.com/r/cnrsinist/ws-loterre-annotate/)
...
- [openalex-classification](./services/openalex-classification) [![Docker Pulls](https://img.shields.io/docker/pulls/cnrsinist/ws-openalex-classification.svg)](https://hub.docker.com/r/cnrsinist/ws-openalex-classification/)
...
- [text-anonymize](./services/text-anonymize) [![Docker Pulls](https://img.shields.io/docker/pulls/cnrsinist/ws-text-anonymize.svg)](https://hub.docker.com/r/cnrsinist/ws-text-anonymize/)
